...
App.Services.CountryService = function ($q, $http) {
    var _urlPeopleData = 'mockJsonData/countries.json';
    var _data = [];
            ...
            return $http.get(_urlPeopleData)
                .then(function (responce) {
                    ...
                    for (var i = 0; i < 100; i++) {
                        ...
                        var vm = App.Models.CountryVM(responce.data[i]);
                        _data.push(vm);
                    }
...
App.Services.CountryService.$inject = ['$q', '$http'];

myApp.factory('countryService', App.Services.CountryService);